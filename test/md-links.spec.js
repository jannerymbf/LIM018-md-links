...
describe('checkPath', () => {
  ...
  it('should return an absolute path', () => {
    const path = 'prueba.md';
    const absolutePath = '/Users/jannerybriceno/Documents/Laboratoria/Proyectos/Proyecto4/LIM018-md-links/prueba.md'
...
describe('extractMd', () => {
  ...
  it('should return an array with the path', () => {
    ...
    expect(extractMd(path)).toContain('/Users/jannerybriceno/Documents/Laboratoria/Proyectos/Proyecto4/LIM018-md-links/prueba.md');
  });
  ...
  it('should join the dir path and the file path', () => {
    ...
    const result = '/Users/jannerybriceno/Documents/Laboratoria/Proyectos/Proyecto4/LIM018-md-links/pruebita/otraprueba.md';
...
describe('extractLinks', () => {
  ...
  it('should return 50-character text', () => {
    const mdFiles = ['/Users/jannerybriceno/Documents/Laboratoria/Proyectos/Proyecto4/LIM018-md-links/prueba2.md'];
    const result = {
  ...
  it('should return an array with objects href, text, file', () => {
    const mdFiles = ['/Users/jannerybriceno/Documents/Laboratoria/Proyectos/Proyecto4/LIM018-md-links/prueba.md'];
    const result = {
      href: 'https://es.wikipedia.org/wiki/Markdown',
      text: 'Markdown',
...
describe('validate and stats', () => {
  ...
  it('should return an object with status and ok', () => {
    ...
    return validateLink({
      href: 'https://es.wikipedia.org/wiki/Markdown',
      text: 'Markdown',
      file: '/Users/jannerybriceno/Documents/Laboratoria/Proyectos/Proyecto4/LIM018-md-links/prueba.md'}).then(response => {expect(response).toEqual({
        href: 'https://es.wikipedia.org/wiki/Markdown',
        text: 'Markdown',
        file: '/Users/jannerybriceno/Documents/Laboratoria/Proyectos/Proyecto4/LIM018-md-links/prueba.md',
        status: 200,
  ...
  it('should return an object with status 404 and fail', () => {
    ...
    return validateLink({
      ...
      text: 'Markdown',
      file: '/Users/jannerybriceno/Documents/Laboratoria/Proyectos/Proyecto4/LIM018-md-links/prueba.md'}).catch(response => {expect(response).toEqual({
        href: 'https://es.wikipedi.org/wiki/Markdown',
        text: 'Markdown',
        file: '/Users/jannerybriceno/Documents/Laboratoria/Proyectos/Proyecto4/LIM018-md-links/prueba.md',
        status: 404,
